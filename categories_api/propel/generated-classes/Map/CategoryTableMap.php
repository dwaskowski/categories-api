...
class CategoryTableMap extends TableMap
{
     ...
     */
    const DATABASE_NAME = 'categories_api';
     ...
     */
    const COL_SLUG = 'category.slug';

    /**
     * the column name for the parentCategoryId field
     */
    const COL_PARENTCATEGORYID = 'category.parentCategoryId';

    /**
     * the column name for the isVisible field
     */
    const COL_ISVISIBLE = 'category.isVisible';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Uuid', 'Name', 'Slug', 'Parentcategoryid', 'Isvisible', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'uuid', 'name', 'slug', 'parentcategoryid', 'isvisible', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_ID, CategoryTableMap::COL_UUID, CategoryTableMap::COL_NAME, CategoryTableMap::COL_SLUG, CategoryTableMap::COL_PARENTCATEGORYID, CategoryTableMap::COL_ISVISIBLE, CategoryTableMap::COL_CREATED_AT, CategoryTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'uuid', 'name', 'slug', 'parentCategoryId', 'isVisible', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Uuid' => 1, 'Name' => 2, 'Slug' => 3, 'Parentcategoryid' => 4, 'Isvisible' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'uuid' => 1, 'name' => 2, 'slug' => 3, 'parentcategoryid' => 4, 'isvisible' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_ID => 0, CategoryTableMap::COL_UUID => 1, CategoryTableMap::COL_NAME => 2, CategoryTableMap::COL_SLUG => 3, CategoryTableMap::COL_PARENTCATEGORYID => 4, CategoryTableMap::COL_ISVISIBLE => 5, CategoryTableMap::COL_CREATED_AT => 6, CategoryTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'uuid' => 1, 'name' => 2, 'slug' => 3, 'parentCategoryId' => 4, 'isVisible' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('parentCategoryId', 'Parentcategoryid', 'INTEGER', 'category', 'id', false, null, null);
        $this->addColumn('isVisible', 'Isvisible', 'BOOLEAN', true, 1, false);
    ...
    {
        $this->addRelation('CategoryRelatedByParentcategoryid', '\\Category', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':parentCategoryId',
    1 => ':id',
        ...
        $this->addRelation('CategoryRelatedById', '\\Category', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':parentCategoryId',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CategoryTableMap::COL_UUID);
            $criteria->addSelectColumn(CategoryTableMap::COL_NAME);
            $criteria->addSelectColumn(CategoryTableMap::COL_SLUG);
            $criteria->addSelectColumn(CategoryTableMap::COL_PARENTCATEGORYID);
            $criteria->addSelectColumn(CategoryTableMap::COL_ISVISIBLE);
            ...
            $criteria->addSelectColumn($alias . '.parentCategoryId');
            $criteria->addSelectColumn($alias . '.isVisible');
